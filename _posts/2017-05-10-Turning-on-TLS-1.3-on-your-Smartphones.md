...
![Chrome Canary](/images/flags.png){:class="img-responsive" height="100px" width="100px"}

III. Search for "Maximum TLS version enabled" and change if from "Default" to "TLS 1.3"

![Verify that TLS 1.3 is turned on](/images/cloudfare.png){:class="img-responsive" height="100px" width="100px"}
